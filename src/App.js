      ...
      <section id="about" className="section">
        <div>
          ...
          <p id="light">
            ...
            visualization... we are here to help out for that you need to just
            talk w/t it.
          </p>
          <p className="InsideSectionHeading">
            AIvisora platforms helps you by providing interactive real time 3D
            visualtization interface paired w/the AI driven characters.
          </p>
          <img
            id="Architecture"
      ...
      <section id="features" className="section">
        ...
        <div className="feature-grid">
          <div className="feature">
            ...
            <p>
              we will provide an Interface where you can Interact and Control
              things which will help you to understand the Visulization
            </p>
          </div>
          <div className="feature">
            <h3>3D Avatars</h3>
